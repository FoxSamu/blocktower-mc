...
/**
 * A storyteller character that adds extra spice to the game. Introduced from the beginning of the game and effective
 * during the whole duration of the game.
 */
data class Loric(
    /**
    ...
    override val style get() = CharacterStyle.LORIC
}
